...
$(package)_patches+= freetype_back_compat.patch drop_lrelease_dependency.patch fix_powerpc_libpng.patch std_limits.patch touch_conflicts.patch
$(package)_cflags+=-DWINVER=0x0601 -D_WIN32_WINNT=0x0601
$(package)_cxxflags+=-DWINVER=0x0601 -D_WIN32_WINNT=0x0601
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/std_limits.patch && \
  patch -p1 -i $($(package)_patch_dir)/touch_conflicts.patch && \
