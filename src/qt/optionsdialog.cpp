...
/*void OptionsDialog::onChangedAiNeuralLeadHashNeuralNetworksParallel()
{
    setMaximumParallelNeuralNetworks( ui->threadsScriptVerif_AiNeuralLeadHashNeuralNetworksParallel->value() );
}

void OptionsDialog::onChangedAiCpuThreads()
{
    setMaximumCPUThreads( ui->threadsScriptVerif_AiCpuThreads->value() );
}*/
    ...
    mapper(nullptr)
{
    ...
    ui->threadsScriptVerif_AiCpuThreads->setMinimum(0);
    ui->threadsScriptVerif_AiCpuThreads->setMaximum(2000000);
    ui->threadsScriptVerif_AiCpuThreads->setValue(getCPUThreads());
    //connect(ui->threadsScriptVerif_AiCpuThreads, SIGNAL(valueChanged(int)), this, SLOT(onChangedAiCpuThreads));

    ui->threadsScriptVerif_AiNeuralLeadHashNeuralNetworksParallel->setMinimum(1);
    ui->threadsScriptVerif_AiNeuralLeadHashNeuralNetworksParallel->setMaximum(2000000);
    ui->threadsScriptVerif_AiNeuralLeadHashNeuralNetworksParallel->setValue(getParallelNeuralNetworks());
    //connect(ui->threadsScriptVerif_AiNeuralLeadHashNeuralNetworksParallel, SIGNAL(valueChanged(int)), this, SLOT(onChangedAiNeuralLeadHashNeuralNetworksParallel));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->bitcoinEnableSystemNotification, OptionsModel::EnableSystemNotification);
    mapper->addMapping(ui->bitcoinEnableAiHashGPU, OptionsModel::EnableSystemNotification);
