...
bool Intro::showIfNeeded(bool& did_show_intro, bool& prune)
{
     ...
     * override -datadir in the neuralleadcoin.conf file in the default data directory
     * (to be consistent with neuralleadcoind behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the NeuralLeadCoin block chain.").arg(PACKAGE_NAME) + " " +
