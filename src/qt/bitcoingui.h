...
/**
  NeuralLeadCoin GUI main class. This class represents the main window of the NeuralLeadCoin UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a NeuralLeadCoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QAction* dataminingAction = nullptr;
    ...
    QTimer* timerCheckHeaders = nullptr;
...
public Q_SLOTS:
    ...
    void gotoStakePage();
    /** Switch to datamining */
    void gotoDataminingPage();

    /** Show Sign/Verify Message dialog and switch to sign message tab */
    void gotoSignMessageTab(QString addr = "");
    /** Show Sign/Verify Message dialog and switch to verify message tab */
    void gotoVerifyMessageTab(QString addr = "");
    /** Load Partially Signed NeuralLeadCoin Transaction from file or clipboard */
