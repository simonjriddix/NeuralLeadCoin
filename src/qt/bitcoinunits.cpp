...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BPS: return QString("NLEAD");
    case mBPS: return QString("mNLEAD");
    case uBPS: return QString::fromUtf8("µNLEAD (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BPS: return QString("NeuralLeadCoins");
    case mBPS: return QString("Milli-NeuralLeadCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBPS: return QString("Micro-NeuralLeadCoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
