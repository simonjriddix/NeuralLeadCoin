...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("EnableSystemNotification"))
        settings.setValue("EnableSystemNotification", true);
    bEnableSystemNotification = settings.value("EnableSystemNotification").toBool();
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BPS);
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case EnableSystemNotification:
            return settings.value("EnableSystemNotification");
        case HideTrayIcon:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case StartAtStartup:
            ...
            break;
        case EnableSystemNotification:
            bEnableSystemNotification = value.toBool();
            settings.setValue("EnableSystemNotification", bEnableSystemNotification);
            break;
        case HideTrayIcon:
