...
static const char* qt_argv = "neuralleadcoin-qt";
...
void BitcoinApplication::createAndCheckUpdateWindow(const NetworkStyle *networkStyle)
{
    bool ShowWindowIfThereIsUpdate = false;

    // Create the update window
    // SJR Automatic Updates
    m_UpdaterWindow = new UpdaterWindow(nullptr, "simonjriddix/neurallead", "0.24.11.08", 2000, ShowWindowIfThereIsUpdate);
    m_UpdaterWindow->setCss(QXCSS());

    if(ShowWindowIfThereIsUpdate)
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6. Determine availability of data directory and parse neuralleadcoin.conf
    ...
    //app.createAndCheckUpdateWindow(networkStyle.data());
