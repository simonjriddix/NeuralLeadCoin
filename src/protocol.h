...
/** New Informations about PoS Node Status to propagate */
extern const char* UPDATE_PoS_NODE_INFO;

/** New (or key updating) PoS inside the list to propagate */
extern const char* ADD_PoS_NODE_INFO;

/** Get infos about PoS node */
extern const char* GET_PoS_NODE_INFO;
