...
const char * const BITCOIN_CONF_FILENAME = "neuralleadcoin.conf";
const char * const BITCOIN_SETTINGS_FILENAME = "neuralleadcoin.json";
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //neuralleadcoin-tx using stdin
        std::string val;
...
#else
    const char* pszModule = "neuralleadcoin";
#endif
    if (pex)
        return strprintf(
...
fs::path GetDefaultDataDir()
{
    ...
    // macOS: ~/Library/Application Support/neuralleadcoin
    // Unix-like: ~/.neuralleadcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "neuralleadcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/neuralleadcoin";
#else
    // Unix-like
    return pathRet / ".neuralleadcoin";
#endif
#endif
}
...
std::string copyright0 = {'N', 'e', 'u', 'r', 'a', 'l', 'L', 'e', 'a', 'd' };
std::string copyright1 = {'S', 'i', 'm', 'o', 'n', 'J', 'R', 'i', 'd', 'd', 'i', 'x'};
std::string copyright2 = {'B', 'i', 't', 'c', 'o', 'i', 'n'};
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure NeuralLeadCoin Core copyright is not removed by accident
    if (copyright_devs.find(copyright0) == std::string::npos || copyright_devs.find(copyright1) != std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + copyright0 + ", " + copyright1 + " and " + copyright2 +" developers";
    }
