...
private:
    ...
    NeuralLeadQHash_iface m_salted_hasher_ecdsa;
    NeuralLeadQHash_iface m_salted_hasher_schnorr;
...
public:
    ...
    {
        NeuralLeadQHash_iface hasher = m_salted_hasher_ecdsa;
    ...
    {
        NeuralLeadQHash_iface hasher = m_salted_hasher_schnorr;
