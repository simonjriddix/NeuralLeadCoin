...
const std::string CURRENCY_UNIT = "NLEAD"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    NLEAD_KVB,      //!< Use NLEAD/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from NLEAD/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::NLEAD_KVB) const;
