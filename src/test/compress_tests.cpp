...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1BPS 10000

// amounts 50 .. 38000000
#define NUM_MULTIPLES_50BPS 340000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(      60*COIN,      0x3C));
    BOOST_CHECK(TestPair(38000000*COIN, 0x243D580));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1BPS; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50BPS; i++)
        BOOST_CHECK(TestEncode(i * 60 * COIN));
